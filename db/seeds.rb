...
review1 = Review.create(text: "wow this movie was exciting!", user_id: 1, movie_id: 4)
review2 = Review.create(text: "i fell asleep during the movie", user_id: 2, movie_id: 4)
review3 = Review.create(text: "epic", user_id: 1, movie_id: 4)
review4 = Review.create(text: "boring", user_id: 2, movie_id: 4)
review5 = Review.create(text: "just wow", user_id: 1, movie_id: 4)
review6 = Review.create(text: "idk what i just watched", user_id: 1, movie_id: 4)